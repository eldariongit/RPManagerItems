...
L["apexis"]                 = "Gamebox 'The sound of Apexis'"
L["apexisComment"]          = "Training for the gray cells."
L["apexisUsage"]            = "Let yourself be enchanted by the sounds."
L["apexisHelp1"]            = "<html><body>"
L["apexisHelp2"]            = "<h2>Instructions</h2>"
L["apexisHelp3"]            = "<p>It starts with a tone that the box plays and that has to be played back correctly. The corresponding button lights up briefly.</p>"
L["apexisHelp4"]            = "<p>In each subsequent round, this sequence is supplemented by another note, so that more and more notes have to be played.</p>"
L["apexisHelp5"]            = "<p>This continues until you make a mistake, take too long or simply give up.</p><br/>"
L["apexisHelp6"]            = "<h1>Created by Priss (Aldor-EU)</h1>"
L["apexisHelp7"]            = "</body></html>"
L["apexisOutput1"]          = "Output: in /p or as system message"
L["apexisOutput2"]          = "Output: in /s"
L["apexisSuccess"]          = "Round... %s... accomplished."
L["apexisDefeat"]           = "Lost in round... %s... due to... %s."
L["apexisReasonError"]      = "error"
L["apexisReasonGiveUp"]     = "give-up"
L["apexisReasonTime"]       = "lack of time"
